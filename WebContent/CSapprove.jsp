		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					...
					try{
					PreparedStatement psmt4=con.prepareStatement("select * from chargingstation where status='Not Approved'");
					ResultSet r=psmt4.executeQuery();%>
					<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
						<h4>Charging Station Approve</h4>
...
\						<td><a href="CS1approve.jsp?cid=<%=r.getInt(1)%>">Approve</a></td>
						</tr>
						<%}}
							catch(Exception e)
					{
