...
<div class="main-content">
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<!-- main content start-->
		<div id="page-wrapper">
		<form action="bookstationservlet" method="post">
			<div class="main-page login-page ">
				<h2 class="title1">Book Charging Slot</h2>
				<div class="widget-shadow">
					<div class="login-body">
						<form action="bookstationservlet" method="post">
							<center>
							<input type="text" name="cid" class="lock" placeholder="Charging station cid" required><br><br>
							<input type="text" name="power" class="lock" placeholder="Power " required><br><br>
							<input type="text" name="timeslot" class="lock" placeholder="Timeslot" required>
							</center>
								</div>
								<div class="clearfix"> </div>
							</div>
